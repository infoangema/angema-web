...
@Component({
  selector: 'app-presupuesto-resumen',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './presupuesto-resumen.component.html',
  styleUrls: ['./presupuesto-resumen.component.css']
})
export class PresupuestoResumenComponent implements OnInit {
