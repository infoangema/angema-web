...
- [ ] Agregar al menu el link para ingresar a almacen
- [ ] Crea page para listar almacenes.
- [ ] verificar servicio existente de almacenes "src/app/modules/stockin-manager/services/warehouse.service.ts".
- [ ] Implementar modal para crear almacenes. ya existe, solo hay que migrarlo a su componente "src/app/modules/stockin-manager/pages/products/create-warehouse/create-warehouse.modal.ts"
- [ ] Si el usuario es root, debe aparecer la seleccion de negocio. si es admin, se crea para su negocio.

### 5. Create de producto.
- [ ] Crear interface de producto para firebase
- [ ] Analizar "src/app/modules/stockin-manager/services/product.service.ts".
- [ ] Completar integracion de "src/app/modules/stockin-manager/pages/products/create-product/create-product.modal.ts" para crear producto.

### 6. Editar de producto.
- [ ] Crear modal para visualizar detalles y edición de productos
- [ ] Agregar botón de acción de editar en products en la columna de acciones
- [x] Implementar eliminación segura
- [x] Validaciones de formulario
- [x] Agregar nueva columna en la lista de productos, con el costo del producto, solo visible por admin.

- [ ] Crear modal de almacenes con guardado en firebase.
- [ ] Crear el modelo para la coleccion de atributos. Este se va a utilizar para pre cargar los seleccionables de color, talle,

### 4. Control de Stock (3 días)
