...
- [ ] Agregar nuev columna en la lista de productos, con el costo del producto, solo visible por admin.
- Modificar el estilo de la lista de productos por el ejemplo a continuacion. debe tener los checks de seleccion para desactivar en bloques, hay que quitar la imagen del producto, esta solo se vera si se visualiza al apretar ver detalles o editar.
```html
